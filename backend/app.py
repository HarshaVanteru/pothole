...
# YOLO model setup
model_weights = 'backend/project_files/yolov4_tiny.weights'  # Path to YOLO weights file
model_config = 'backend/project_files/yolov4_tiny.cfg'  # Path to YOLO configuration file
classes_file = 'backend/project_files/obj.names'  # Path to file containing class names
